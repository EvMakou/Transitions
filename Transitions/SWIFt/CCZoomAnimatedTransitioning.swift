...
class CCZoomAnimatedTransitioning: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if (self.isPresentation)
        {
            ...
            transitvshadow.contentMode = .scaleToFill;
...
UIView.animateKeyframes(withDuration: self.transitionDuration(using: transitionContext),
                        delay: 0,
                        options: .calculationModeCubic,// calculationModeCubic
                        animations: {
                            //shadow
            ...
            UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 0.5, animations: {
                ...
                transitvshadow.layer.cornerRadius = 30;
                blurshadow.alpha = 1;
                blurshadow.layer.cornerRadius = 30;
